...
#define NFUNCTION		0x00FFFFFDL	/* alte unterscheidung     */
...
#define DECL_CR		0x0000007aL	/* editor und reduma         */
...
#define DELETE_CR	0x006a0021L
#define AND_CR		0x006b0011L
#define SEL_CR		0x006c0021L
#define UPDATE_CR	0x006d0031L
