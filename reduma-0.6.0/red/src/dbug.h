...
/* #define DBUG_RETURN(a1) if (1) DBUG_PRINT("RETURN", ("return value %d=%08x", a1, a1)); return (DBUG_LEAVE, (a1)); } else */
...
#define DBUG_PRINT(keyword,arglist) \
      if (!_db_on_) ; else ( _db_pargs_(__LINE__,keyword), _db_doprnt_ arglist )
