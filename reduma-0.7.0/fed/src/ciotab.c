...
,E_FUNC,        IA_FPRINTF,     "fprintf",      "",     0,6,0 | PREDEF
,E_FUNC,        IA_FSCANF,      "fscanf",       "",     0,5,0 | PREDEF
...
predefined interactions[] = {
    ...
    ,"fprintf"  ,IA_FPRINTF ,func_arity(IA_FPRINTF)
    ,"fputc"    ,IA_FPUTC   ,func_arity(IA_FPUTC)
    ,"fputs"    ,IA_FPUTS   ,func_arity(IA_FPUTS)
    ,"fscanf"   ,IA_FSCANF  ,func_arity(IA_FSCANF)
