...
#define MINDEX_PROC_DIST 12
#define D_M_C_PROC_DIST D_M_CHECK(12)
#define MPRINT_ASCII_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC) \
	fprintf(F, "%.lf %d %d PROC_DIST %d\n", TIME, PROC, PID, PD_NEXT_PROC)
#define MPRINT_BINARY_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC) \
	M_TIMER_TYPE_BUF = TIME, fwrite(&M_TIMER_TYPE_BUF, sizeof(M_TIMER_TYPE), 1, F), \
	M_BINARY_COUNT = sizeof(PROCESS_NR_TYPE) + sizeof(PROCESS_PID_TYPE) + sizeof(M_CHAR_BUF) + sizeof(M_INT_BUF), \
	fwrite(&M_BINARY_COUNT, sizeof(M_BINARY_COUNT_TYPE), 1, F), \
	PROCESS_NR_BUF = PROC, fwrite(&PROCESS_NR_BUF, sizeof(PROCESS_NR_TYPE), 1, F), \
	...
	1
#ifdef M_BINARY
#define MPRINT_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC) \
	MPRINT_BINARY_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC)
#else
#define MPRINT_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC) \
	MPRINT_ASCII_PROC_DIST(F, TIME, PROC, PID, PD_NEXT_PROC)
#endif

#define MINDEX_PROC_NODIST 13
#define D_M_C_PROC_NODIST D_M_CHECK(13)
...
#define MINDEX_PROC_CREATE 14
#define D_M_C_PROC_CREATE D_M_CHECK(14)
...
#define MINDEX_PROC_TERMINATE 15
#define D_M_C_PROC_TERMINATE D_M_CHECK(15)
...
#define MINDEX_PROC_DISTEND 16
#define D_M_C_PROC_DISTEND D_M_CHECK(16)
...
#define MINDEX_PROC_SLEEP 17
#define D_M_C_PROC_SLEEP D_M_CHECK(17)
...
#define MINDEX_PROC_RUN 18
#define D_M_C_PROC_RUN D_M_CHECK(18)
...
#define MINDEX_PROC_WAKEUP 19
#define D_M_C_PROC_WAKEUP D_M_CHECK(19)
...
#define MINDEX_SEND_BEGIN 20
#define D_M_C_SEND_BEGIN D_M_CHECK(20)
...
#define MINDEX_SEND_END 21
#define D_M_C_SEND_END D_M_CHECK(21)
...
#define MINDEX_RECEIVE_BEGIN 22
#define D_M_C_RECEIVE_BEGIN D_M_CHECK(22)
...
#define MINDEX_RECEIVE_END 23
#define D_M_C_RECEIVE_END D_M_CHECK(23)
...
#define MINDEX_COUNT_PUSH 24
#define D_M_C_PUSH D_M_CHECK(24)

#define MINDEX_COUNT_PUSHC 25
#define D_M_C_PUSHC D_M_CHECK(25)

#define MINDEX_COUNT_PUSHARG 26
#define D_M_C_PUSHARG D_M_CHECK(26)

#define MINDEX_COUNT_PUSHARG0 27
#define D_M_C_PUSHARG0 D_M_CHECK(27)

#define MINDEX_COUNT_MOVE 28
#define D_M_C_MOVE D_M_CHECK(28)

#define MINDEX_COUNT_DELTA1 29
#define D_M_C_DELTA1 D_M_CHECK(29)

#define MINDEX_COUNT_DELTA2 30
#define D_M_C_DELTA2 D_M_CHECK(30)

#define MINDEX_COUNT_DELTA3 31
#define D_M_C_DELTA3 D_M_CHECK(31)

#define MINDEX_COUNT_DELTA4 32
#define D_M_C_DELTA4 D_M_CHECK(32)

#define MINDEX_COUNT_ADD 33
#define D_M_C_ADD D_M_CHECK(33)

#define MINDEX_COUNT_SUB 34
#define D_M_C_SUB D_M_CHECK(34)

#define MINDEX_COUNT_MUL 35
#define D_M_C_MUL D_M_CHECK(35)

#define MINDEX_COUNT_DIV 36
#define D_M_C_DIV D_M_CHECK(36)

#define MINDEX_COUNT_MOD 37
#define D_M_C_MOD D_M_CHECK(37)

#define MINDEX_COUNT_EQ 38
#define D_M_C_EQ D_M_CHECK(38)

#define MINDEX_COUNT_NE 39
#define D_M_C_NE D_M_CHECK(39)

#define MINDEX_COUNT_LT 40
#define D_M_C_LT D_M_CHECK(40)

#define MINDEX_COUNT_LE 41
#define D_M_C_LE D_M_CHECK(41)

#define MINDEX_COUNT_GT 42
#define D_M_C_GT D_M_CHECK(42)

#define MINDEX_COUNT_GE 43
#define D_M_C_GE D_M_CHECK(43)

#define MINDEX_COUNT_NEG 44
#define D_M_C_NEG D_M_CHECK(44)

#define MINDEX_COUNT_NOT 45
#define D_M_C_NOT D_M_CHECK(45)

#define MINDEX_COUNT_OR 46
#define D_M_C_OR D_M_CHECK(46)

#define MINDEX_COUNT_AND 47
#define D_M_C_AND D_M_CHECK(47)

#define MINDEX_COUNT_XOR 48
#define D_M_C_XOR D_M_CHECK(48)

#define MINDEX_COUNT_JFALSE 49
#define D_M_C_JFALSE D_M_CHECK(49)

#define MINDEX_COUNT_JTRUE 50
#define D_M_C_JTRUE D_M_CHECK(50)

#define MINDEX_COUNT_JCOND 51
#define D_M_C_JCOND D_M_CHECK(51)

#define MINDEX_COUNT_PUSHRET 52
#define D_M_C_PUSHRET D_M_CHECK(52)

#define MINDEX_COUNT_BETA 53
#define D_M_C_BETA D_M_CHECK(53)

#define MINDEX_COUNT_BETA0 54
#define D_M_C_BETA0 D_M_CHECK(54)

#define MINDEX_COUNT_BETA1 55
#define D_M_C_BETA1 D_M_CHECK(55)

#define MINDEX_COUNT_JTAIL 56
#define D_M_C_JTAIL D_M_CHECK(56)

#define MINDEX_COUNT_JTAIL0 57
#define D_M_C_JTAIL0 D_M_CHECK(57)

#define MINDEX_COUNT_JTAIL1 58
#define D_M_C_JTAIL1 D_M_CHECK(58)

#define MINDEX_COUNT_BETAQ 59
#define D_M_C_BETAQ D_M_CHECK(59)

#define MINDEX_COUNT_BETAQ0 60
#define D_M_C_BETAQ0 D_M_CHECK(60)

#define MINDEX_COUNT_BETAQ1 61
#define D_M_C_BETAQ1 D_M_CHECK(61)

#define MINDEX_COUNT_JTAILQ 62
#define D_M_C_JTAILQ D_M_CHECK(62)

#define MINDEX_COUNT_JTAILQ0 63
#define D_M_C_JTAILQ0 D_M_CHECK(63)

#define MINDEX_COUNT_JTAILQ1 64
#define D_M_C_JTAILQ1 D_M_CHECK(64)

#define MINDEX_COUNT_FREE 65
#define D_M_C_FREE D_M_CHECK(65)

#define MINDEX_COUNT_FREE1 66
#define D_M_C_FREE1 D_M_CHECK(66)

#define MINDEX_COUNT_RTF 67
#define D_M_C_RTF D_M_CHECK(67)

#define MINDEX_COUNT_RTM 68
#define D_M_C_RTM D_M_CHECK(68)

#define MINDEX_COUNT_RTP 69
#define D_M_C_RTP D_M_CHECK(69)

#define MINDEX_COUNT_RTC 70
#define D_M_C_RTC D_M_CHECK(70)

#define MINDEX_COUNT_MKGCLOS 71
#define D_M_C_MKGCLOS D_M_CHECK(71)

#define MINDEX_COUNT_MKBCLOS 72
#define D_M_C_MKBCLOS D_M_CHECK(72)

#define MINDEX_COUNT_MKCCLOS 73
#define D_M_C_MKCCLOS D_M_CHECK(73)

#define MINDEX_COUNT_MKSCLOS 74
#define D_M_C_MKSCLOS D_M_CHECK(74)

#define MINDEX_COUNT_MKDCLOS 75
#define D_M_C_MKDCLOS D_M_CHECK(75)

#define MINDEX_COUNT_MKAP 76
#define D_M_C_MKAP D_M_CHECK(76)

#define MINDEX_COUNT_APPLY 77
#define D_M_C_APPLY D_M_CHECK(77)

#define MINDEX_COUNT_CASE 78
#define D_M_C_CASE D_M_CHECK(78)

#define MINDEX_COUNT_WHEN 79
#define D_M_C_WHEN D_M_CHECK(79)

#define MINDEX_COUNT_GUARD 80
#define D_M_C_GUARD D_M_CHECK(80)

#define MINDEX_COUNT_BODY 81
#define D_M_C_BODY D_M_CHECK(81)

#define MINDEX_COUNT_NOMATCH 82
#define D_M_C_NOMATCH D_M_CHECK(82)

#define MINDEX_COUNT_DUPARG 83
#define D_M_C_DUPARG D_M_CHECK(83)

#define MINDEX_COUNT_LSEL 84
#define D_M_C_LSEL D_M_CHECK(84)

#define MINDEX_COUNT_CONS 85
#define D_M_C_CONS D_M_CHECK(85)

#define MINDEX_COUNT_FCONS 86
#define D_M_C_FCONS D_M_CHECK(86)

#define MINDEX_COUNT_FIRST 87
#define D_M_C_FIRST D_M_CHECK(87)

#define MINDEX_COUNT_REST 88
#define D_M_C_REST D_M_CHECK(88)

#define MINDEX_COUNT_EXT 89
#define D_M_C_EXT D_M_CHECK(89)

#define MINDEX_COUNT_MKILIST 90
#define D_M_C_MKILIST D_M_CHECK(90)

#define MINDEX_COUNT_MKLIST 91
#define D_M_C_MKLIST D_M_CHECK(91)

#define MINDEX_COUNT_PUSHH 92
#define D_M_C_PUSHH D_M_CHECK(92)

#define MINDEX_COUNT_DISTEND 93
#define D_M_C_DISTEND D_M_CHECK(93)

#define MINDEX_COUNT_WAIT 94
#define D_M_C_WAIT D_M_CHECK(94)

#define MINDEX_COUNT_POPH 95
#define D_M_C_POPH D_M_CHECK(95)
