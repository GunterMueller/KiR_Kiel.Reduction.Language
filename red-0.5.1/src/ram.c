...
#if nCUBE
extern DStackDesc *ps_a;         /* zeiger auf aktuellen a-stack */
extern DStackDesc *ps_i;         /* zeiger auf aktuellen i-stack */
#else
extern StackDesc *ps_a;         /* zeiger auf aktuellen a-stack */
extern StackDesc *ps_i;         /* zeiger auf aktuellen i-stack */
#endif
...
#define PUSH_PM(x)       D_PUSHSTACK((*ps_i),(x))
#define PPOP_PM()        D_PPOPSTACK((*ps_i))
#define POP_PM()         D_POPSTACK((*ps_i))
#define TOP_PM()         D_READSTACK((*ps_i))
#else
#define PUSH_R(x)        PUSHSTACK(S_m,(x))
#define PUSH_A(x)        PUSHSTACK((*ps_a),(x))

#define PUSH_PM(x)       PUSHSTACK((*ps_i),(x))
#define PPOP_PM()        PPOPSTACK((*ps_i))
#define POP_PM()         POPSTACK((*ps_i))
#define TOP_PM()         READSTACK((*ps_i))
#endif
