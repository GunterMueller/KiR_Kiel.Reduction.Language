...
/*                 31 24 23  16 15       8 7   4 3  0                        */
/*                +-----+------+----------+-----+----+                       */
/* functions:     |       name     edit    arity 1000|                       */
/*                +-----+------+----------+-----+----+                       */
/*                                                                           */
/*                 31        16 15       8 7   4 3  0                        */
/*                +------------+----------+-----+----+ x: letter/digit       */
...
#ifndef T_POINTER
#define T_POINTER(x)       (((int)(x) & P_POINTER) == POINTER)
#endif
...
#define T_EXT_POINTER(elem)  (T_POINTER(elem) || T_STAT_POINTER(elem) || T_DESC_INDEX(elem))
...
#define _SUBPRE            4
#define P_SUBPRE           P_CVARCOMPL
#define SUBPRE             VARCON(_SUBPRE)
#define T_SUBPRE(x)        (((x) & P_SUBPRE) == SUBPRE)
