...
/* original was rlogfunc.c, difference is that here won't be any             */
...
extern BOOLEAN str_eq();
extern BOOLEAN str_le();
extern BOOLEAN str_lt();
extern BOOLEAN pm_element();
...
/* calls    :  boolmvt_bop.                                                  */
/*****************************************************************************/
int nr_red_not(arg1)         /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
  char class1;

  DBUG_ENTER ("nr_red_not");

  START_MODUL("nr_red_not");

  if T_BOOLEAN(arg1) {
    _desc = (PTR_DESCRIPTOR) (T_SA_FALSE(arg1) ? SA_TRUE : SA_FALSE);
    END_MODUL("nr_red_not");
    DBUG_RETURN(1);
  }
...
/*****************************************************************************/
int nr_red_or(arg1,arg2)                  /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  STACKELEM result;
       char class1,class2;

  DBUG_ENTER ("nr_red_or");

  START_MODUL("nr_red_or");
...
fail:
  END_MODUL("nr_red_or");DBUG_RETURN(0);
...
/* calls    :  boolmvt_bop, bmvt_bmvt_bop                                    */
/*****************************************************************************/
int nr_red_and(arg1,arg2)                    /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  STACKELEM result;
       char class1,class2;

  DBUG_ENTER ("nr_red_and");

  START_MODUL("nr_red_and");
...
/* calls    :  boolmvt_bop, bmvt_bmvt_bop                                    */
/*****************************************************************************/
int nr_red_xor(arg1,arg2)                    /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  STACKELEM result;
       char class1,class2;

  DBUG_ENTER ("nr_red_xor"); 

  START_MODUL("nr_red_xor");
...
fail:
  END_MODUL("nr_red_xor");DBUG_RETURN(0);

success:
  END_MODUL("nr_red_xor");
  DBUG_RETURN(1);
...
/*             str_lt,          str_mvt_bop                                  */
/*****************************************************************************/
int nr_red_lt(arg1,arg2)                        /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register STACKELEM result;
/*char class1,class2;                         RS 30/10/92 */ 

  DBUG_ENTER ("nr_red_lt");

  START_MODUL("nr_red_lt");
...
int nr_red_geq(arg1,arg2)                    /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register STACKELEM result;
/*char class1,class2;                       RS 30/10/92 */ 

  DBUG_ENTER ("nr_red_geq");

  START_MODUL("nr_red_geq");
  if (T_INT(arg1))
     { 								/* INT >= ? */
      if (T_INT(arg2))
	 { 							/* INT >= INT */
...
int nr_red_eq(arg1,arg2)                        /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register BOOLEAN result;
              char class1,class2;

  DBUG_ENTER ("nr_red_eq");

  START_MODUL("nr_red_eq");

/*dg*/ if (T_2INT(arg1,arg2)) {
/*dg*/   _desc = (PTR_DESCRIPTOR) (EQ_INT(arg1,arg2));
/*dg*/   END_MODUL("nr_red_eq");
/*dg*/   DBUG_RETURN(1);
/*dg*/ }
  if T_POINTER(arg1) {
...
/*dg*/       result = R_DESC(DESC(arg2),class) == C_SCALAR
               ...
               if (type1 == type2) {                 /*   type1  == type2   */
                 switch(type1) {                     /*---------------------*/
                   ...
                   case TY_REAL:
                        ...
                        goto decrement;
                   default:
                        post_mortem("nr_red_eq: unknown mvt - type");
        ...
        default:
             post_mortem("nr_red_eq: unexpected descriptor class");
      } /** end switch(class1) **/
    } /** end T_POINTER(arg2) **/
    else {
...
fail:
  END_MODUL("nr_red_eq"); DBUG_RETURN(0);
decrement:
success:
...
int /* TB, 30.10.92 */
nr_red_neq(arg1,arg2)
register STACKELEM arg1,arg2;
{
  DBUG_ENTER ("nr_red_neq");

  START_MODUL("nr_red_eq");
  if (nr_red_eq(arg1,arg2)) {
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_le");

  START_MODUL("nr_red_le");
  if (T_INT(arg1))
     { 								/* INT <= ? */
      if (T_INT(arg2))
	 { 							/* INT <= INT */
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_gt");

  START_MODUL("nr_red_gt");
  if (T_INT(arg1))
     { 								/* INT > ? */
      if (T_INT(arg2))
	 { 							/* INT > INT */
...
/*****************************************************************************/
int /* TB, 30.10.92 */
nr_red_min(arg1,arg2)
register STACKELEM arg1,arg2;
{
  register STACKELEM result;

  DBUG_ENTER ("nr_red_min");

  START_MODUL("nr_red_min");
...
fail:
  END_MODUL("nr_red_min"); DBUG_RETURN(0);

decrement:
success:
  _desc = (PTR_DESCRIPTOR) result;
  END_MODUL("nr_red_min");
  DBUG_RETURN(1);
decref_arg1:
  _desc = (PTR_DESCRIPTOR) result;
  END_MODUL("nr_red_min");
...
fail:
  END_MODUL("nr_red_max"); DBUG_RETURN(0);

decrement:
success:
  _desc = (PTR_DESCRIPTOR) result;
  END_MODUL("nr_red_max");
  DBUG_RETURN(1);
decref_arg1:
  _desc = (PTR_DESCRIPTOR) result;
  END_MODUL("nr_red_max");
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_f_eq");

  START_MODUL("nr_red_f_eq");
  ...
  if (type1 == type2) {                              /*  type1  ==  type2    */
    switch(type1) {                                  /*----------------------*/
     ...
     /*                                                       dies schon tun */
      ...
      default  : post_mortem("nr_red_f_eq: unknown mvt - type");
    } /** end switch type1 **/
  } /** end type1 == type2 **/                       /*---------------------*/
  else {                                             /*   type1 != type2    */
                                                     /*---------------------*/
