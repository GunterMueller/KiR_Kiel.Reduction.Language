...
/* original was rvstruct.c, difference is that here won't be any             */
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_vcut");
  START_MODUL("nr_red_vcut");
...
int nr_red_vselect(arg1,arg2)
register STACKELEM arg1,arg2;
{
  int rowcol;                          /* Strukturierungsargument            */
  char   class1;                       /* class des Deskriptors arg2         */

  DBUG_ENTER ("nr_red_vselect");
  START_MODUL("nr_red_vselect");
  ...
  if ((T_POINTER(arg1) || T_INT(arg1)) && T_POINTER(arg2)) {
    ...
    switch (R_DESC(DESC(arg2),type)) {             /*------------------------*/
      case TY_INTEGER:
           /* changes for lred by RS in June 1993 */
           if (_formated) {
             DBUG_PRINT ("nr_red_vselect", ("the value is: %d", (((int *) R_MVT(DESC(arg2),ptdv,class1))[rowcol])));
...
int nr_red_vreplace(arg1,arg2,arg3)
STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_vreplace");
  START_MODUL("nr_red_vreplace");
...
STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_vrotate");
  START_MODUL("nr_red_vrotate");
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_vunite");
  START_MODUL("nr_red_vunite");
