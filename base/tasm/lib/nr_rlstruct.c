...
/* original was rlstruct.c, difference is that here won't be any             */
...
extern PTR_DESCRIPTOR  gen_id();                       /* forward declaration      */
extern PTR_DESCRIPTOR  gen_ind();                      /* forward declaration      */
...
/*                      list   with TY_STRING                                */
/*****************************************************************************/
int nr_red_lselect(arg1,arg2)
register STACKELEM arg1,arg2;
{

  DBUG_ENTER ("nr_red_lselect");

  START_MODUL("nr_red_lselect");
...
/*                      list   with TY_STRING                                */
/*****************************************************************************/
int nr_red_substr(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_substr");

  START_MODUL("nr_red_substr");
...
STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_lrotate");

  START_MODUL("nr_red_lrotate");
  ...
  if (T_POINTER(arg2) && R_DESC(DESC(arg2),class) == C_LIST) {
    ...
    if (dim > 0) {
      ...
      /*  success: */
      SCAV_SET(_scav1,0);
      END_MODUL("nr_red_lrotate");
      DBUG_RETURN(1);
    }
    /* else nil | nilstring */
  nothingtodo:
    if (T_POINTER(arg2)) INC_REFCNT((PTR_DESCRIPTOR)arg2);
...
/*               arg2 - (Liste)                                               */
/******************************************************************************/
int nr_red_lcut(arg1,arg2)
register STACKELEM arg1,arg2;
{

  DBUG_ENTER ("nr_red_lcut");

  START_MODUL("nr_red_lcut");
  if (T_POINTER(arg2) && R_DESC(DESC(arg2),class) == C_LIST) {
    register int dim;
    int cut;
    dim = R_LIST(DESC(arg2),dim);
...
register STACKELEM arg1,arg2;
{
  ...
  DBUG_ENTER ("nr_red_lunite");

  START_MODUL("nr_red_lunite");
...
/*                      TY_UNDEF        TY_STRING                            */
/*****************************************************************************/
int nr_red_reverse(arg1)
register STACKELEM arg1;
{
  register int i,j,dim;
  int *ip,*ipnew;

  DBUG_ENTER ("nr_red_reverse");

  START_MODUL("nr_red_reverse");
...
/*             arg3 - list                                                   */
/*****************************************************************************/
int nr_red_ltransform(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_ltransform");

  START_MODUL("nr_red_ltransform");
...
/*                      TY_UNDEF        TY_STRING                            */
/*****************************************************************************/
int nr_red_repstr(arg1,arg2,arg3,arg4)
STACKELEM arg1,arg2,arg3,arg4;
{
  ...
  DBUG_ENTER ("nr_red_repstr");

  START_MODUL("nr_red_repstr");

  if T_CON(arg3)             /* zwar kann repstr beliebige Aus-       */
  {                          /* druecke in eine Liste einbauen, aber  */
    END_MODUL("nr_red_repstr"); /* falls ear fuer Konstruktorausdruecke  */
...
/*                      TY_UNDEF        TY_STRING                            */
/*****************************************************************************/
int nr_red_lreplace(arg1,arg2,arg3)
STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_lreplace");

  START_MODUL("nr_red_lreplace");

  if T_CON(arg2)              /* zwar kann lreplace beliebige Aus-   */
  {                           /* druecke in eine Liste einbauen, aber*/
    END_MODUL("nr_red_lreplace");/* falls ear fuer Konstruktorausdruecke*/
    DBUG_RETURN(0);                /* keinen expression-Pointer anlegt, so*/
  }                           /* kann das nur bedeuten, das _redcnt  */
  /* gleich Null ist und keine Beta-Reduktionen gezaehlt werden sollen*/
  /* lreplace darf diesen Ausdruck aber auch nicht selbst auslagern,da*/
