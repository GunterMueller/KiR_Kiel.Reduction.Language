...
/* original was rvalfunc.c, difference is that here won't be any             */
...
/*                                                                           */
/*---------------------------------------------------------------------------*/
int nr_red_plus(arg1,arg2)            /* int eingefuegt RS 30/10/92 */
register STACKELEM arg1,arg2;
{
/*int i1,i2;              RS 30/10/92 */
  double r1/*,r2*/;    /* RS 30/10/92 */

  DBUG_ENTER ("nr_red_plus");

  START_MODUL("nr_red_plus");
...
/* res_arg1_int:                            RS 30/10/92 */
    ...
    T_INC_REFCNT((PTR_DESCRIPTOR)arg1);
    END_MODUL("nr_red_plus");
    
res_arg2:
/* res_arg2_int:                            RS 30/10/92 */
    _desc = (PTR_DESCRIPTOR) arg2;
    T_INC_REFCNT((PTR_DESCRIPTOR)arg2);
    END_MODUL("nr_red_plus");
    DBUG_RETURN(1);
success:
scalar_success:
 ...
 *---------------------------------------------------------------------------
 */
int nr_red_minus(arg1,arg2)  /* int eingefuegt RS 30/10/92 */
register STACKELEM arg1,arg2;
{
/*int i1,i2;     RS 30/10/92 */
  double r1/*,r2*/;  /* RS 30/10/92 */

  DBUG_ENTER ("nr_red_minus");

  START_MODUL("nr_red_minus");
...
/* res_arg2:                                 RS 30/10/92 */
 /* T_INC_REFCNT((PTR_DESCRIPTOR)arg2);  */          /* RS 04/11/92 */ 
/*
res_arg2_int:                                RS 30/10/92 */
/*  _desc = (PTR_DESCRIPTOR) arg2;
    END_MODUL("nr_red_minus");
 ...
 *---------------------------------------------------------------------------
 */
int nr_red_mult(arg1,arg2)               /* int eingefuegt RS 30/10/92 */
register STACKELEM arg1,arg2;
{
/*int i1,i2;
  double r1,r2;               RS 30/10/92 */

  DBUG_ENTER ("nr_red_mult");

  START_MODUL("nr_red_mult");
 ...
 *---------------------------------------------------------------------------
 */
int nr_red_div(arg1,arg2)                 /* int eingefuegt von RS 30/10/92 */
register STACKELEM arg1,arg2;
{
/*  int i1,i2;                 RS 30/10/92 */
  double /*r1,*/ r2;        /* RS 30/10/92 */

  DBUG_ENTER ("nr_red_div");

  START_MODUL("nr_red_div");
...
/* why should arg2 be a INT if the switch matches ? */
		             ...
		             DESC_MASK(arg1,1,C_SCALAR,TY_INTEGER) ;
		             L_SCALAR((* (PTR_DESCRIPTOR) arg1),vali) = help ;
     DBUG_PRINT ("nr_red_div", ("Here we are !!"));
                            }
                            break ;
                      default: goto fail;
                     }
 ...
 *---------------------------------------------------------------------------
 */
int nr_red_quot(arg1,arg2)                 /* int eingefuegt von RS 30/10/92 */
register STACKELEM arg1,arg2;
{
/*  int i1,i2;                 RS 30/10/92 */
 /*  double r1, r2; */        /* RS 30/10/92 & 28/10/93 */
  ...
  DBUG_ENTER ("nr_red_quot");

  START_MODUL("nr_red_quot");
...
/* why should arg2 be a INT if the switch matches ? */
                             ...
                             DESC_MASK(arg1,1,C_SCALAR,TY_INTEGER) ;
                             L_SCALAR((* (PTR_DESCRIPTOR) arg1),vali) = help ;
     DBUG_PRINT ("nr_red_quot", ("Here we are !!"));
                            }
                            break ;
                      default: goto fail;
                     }
...
/*            Die Aufgabe der Funktion wird bei red_plus erlaeutert.         */
/*---------------------------------------------------------------------------*/
int nr_red_mod(arg1,arg2)               /* int eingefuegt von RS 30/10/92 */
register STACKELEM arg1,arg2;
{
  int /* i1,i2, */ m ;        /* RS 30/10/92 */                     
  double r1,r2=(double)0,help,fractal ; /* Initialisierung von TB, 6.11.1992 */

  DBUG_ENTER ("nr_red_mod");

  START_MODUL("nr_red_mod");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_abs(arg1)              /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
  double r1;

  DBUG_ENTER ("nr_red_abs");

  START_MODUL("nr_red_abs");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_neg(arg1)                /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
/*double r1;               RS 30/10/92 */ 

  DBUG_ENTER ("nr_red_neg");

  START_MODUL("nr_red_neg");
  if (T_INT(arg1))
     { 								/* INT */
       _desc = (PTR_DESCRIPTOR)NEG_INT(arg1) ;
        goto scalar_success_int1 ;
 ...
 *------------------------------------------------------------------------
 */
int nr_red_trunc(arg1)                 /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{

  DBUG_ENTER ("nr_red_trunc");

  START_MODUL("nr_red_trunc");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_frac(arg1)               /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
  double r ;

  DBUG_ENTER ("nr_red_frac");

  START_MODUL("nr_red_frac");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_floor(arg1)                 /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
  double r ;

  DBUG_ENTER ("nr_red_floor");

  START_MODUL("nr_red_floor");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_ceil(arg1)                   /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1;
{
  int i ;
  double r ;

  DBUG_ENTER ("nr_red_ceil");

  START_MODUL("nr_red_ceil");
 ...
 *--------------------------------------------------------------------------
 */
int nr_red_ip(arg1,arg2)                    /* int eingefuegt von RS 30/10/92 */ 
register PTR_DESCRIPTOR arg1,arg2;
{
  ...
  DBUG_ENTER("nr_red_ip");

  START_MODUL("nr_red_ip");
 ...
 *-------------------------------------------------------------------------
 */
int nr_red_c(arg1,arg2)           /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  DBUG_ENTER ("nr_red_c");
...
int nr_red_c_max(arg1,arg2)         /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register int i,j;
  ...
  DBUG_ENTER ("nr_red_c_max");

  START_MODUL("nr_red_c_max");
...
int nr_red_c_min(arg1,arg2)               /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register int i,j;
  PTR_DESCRIPTOR digit1/*,digit2,digit3*/;     /* RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_c_min");

  START_MODUL("nr_red_c_min");
...
int nr_red_c_plus(arg1,arg2)                    /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register int i,j;
  ...
  DBUG_ENTER ("nr_red_c_plus");

  START_MODUL("nr_red_c_plus");
...
int nr_red_c_minus(arg1,arg2)               /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register int i,j;
  PTR_DESCRIPTOR digit1,digit2,digit3;
...
/*int op;                                      RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_c_minus");

  START_MODUL("nr_red_c_minus");
...
int nr_red_c_mult(arg1,arg2)                /* int eingefuegt von RS 30/10/92 */
register STACKELEM arg1,arg2;
{
  register int i,j;
  PTR_DESCRIPTOR digit1,digit2/*,digit3*/;       /* RS 30/10/92 */
  ...
  DBUG_ENTER ("nr_red_c_mult");

  START_MODUL("nr_red_c_mult");
...
int nr_red_c_div(arg1,arg2)               /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  register int i,j;
  PTR_DESCRIPTOR digit1,digit2/*,digit3*/;        /* RS 30/10/92 */  
  ...
  DBUG_ENTER ("nr_red_c_div");

  START_MODUL("nr_red_c_div");
 ...
 *-------------------------------------------------------------------------
 */
int nr_red_vc(arg1,arg2)                       /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg1,arg2;
{
  DBUG_ENTER ("nr_red_vc");

  DBUG_RETURN(0);
}

int 	nr_red_vc_max(arg)                   /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  ...
  DBUG_ENTER ("nr_red_vc_max");

  START_MODUL("nr_red_vc_max");
...
int 	nr_red_vc_min(arg)                   /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  register int i/*,j*/;                     /* RS 30/10/92 */ 
  PTR_DESCRIPTOR digit1/*,digit2,digit3*/;  /* RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_vc_min");

  START_MODUL("nr_red_vc_min");
...
int nr_red_vc_plus(arg)                 /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  register int i/*,j*/;                     /* RS 30/10/92 */ 
  PTR_DESCRIPTOR digit1,digit2/*,digit3*/;  /* RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_vc_plus");

  START_MODUL("nr_red_vc_plus");
...
int nr_red_vc_minus(arg)                 /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  register int i/*,j*/;                    /* RS 30/10/92 */ 
  PTR_DESCRIPTOR digit1,digit2/*,digit3*/; /* RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_vc_minus");

  START_MODUL("nr_red_vc_minus");
...
int nr_red_vc_mult(arg)                /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  register int i/*,j*/;                      /* RS 30/10/92 */  
  PTR_DESCRIPTOR digit1,digit2/*,digit3*/;   /* RS 30/10/92 */ 
  ...
  DBUG_ENTER ("nr_red_vc_mult");

  START_MODUL("nr_red_vc_mult");
...
int nr_red_vc_div(arg)                             /* int eingefuegt von RS 30/10/92 */ 
register STACKELEM arg;
{
  register int i/*,j*/;                       /* RS 30/10/92 */ 
  PTR_DESCRIPTOR digit1/*,digit2,digit3*/;    /* RS 30/10/92 */   
  ...
  DBUG_ENTER ("nr_red_vc_div");

  START_MODUL("nr_red_vc_div");
 ...
 *------------------------------------------------------------------------
 */
int nr_red_to_char(register STACKELEM arg1)
{
  int ret = 0;
  char s[2];

  DBUG_ENTER ("nr_red_to_char");
  START_MODUL("nr_red_to_char");
  ...
  END_MODUL("nr_red_to_char");
  DBUG_RETURN(ret);
}

/*------------------------------------------------------------------------
 * nr_red_to_ord --                                       stt 28.02.96
 *
 ...
 *------------------------------------------------------------------------
 */
int nr_red_to_ord(register STACKELEM arg1)
{
  int ret = 0;
  int val;
  PTR_HEAPELEM  ptdv;

  DBUG_ENTER ("nr_red_to_ord");
  START_MODUL("nr_red_to_ord");
  ...
  END_MODUL("nr_red_to_ord");
  DBUG_RETURN(ret);
}

/*------------------------------------------------------------------------
 * nr_red_sprintf --                                       stt 28.02.96
 *
 ...
 *------------------------------------------------------------------------
 */
int nr_red_sprintf(register STACKELEM fs, register STACKELEM arg)
{
  int ret = 0, len;
  int contens;   /* 0: fs not valid, 1: int Pattern, 2: double Pattern */
  char s[200], format[12], *fstmp;

  DBUG_ENTER ("nr_red_sprintf");
  START_MODUL("nr_red_sprintf");
  ...
  END_MODUL("nr_red_sprintf");
  DBUG_RETURN(ret);
}

/*------------------------------------------------------------------------
 * nr_red_sscanf --                                       stt 28.02.96
 *
 ...
 *------------------------------------------------------------------------
 */
int nr_red_sscanf(register STACKELEM fs, register STACKELEM arg)
{
  int ret = 0, len;
  int contens;   /* 0: fs not valid, 1: int Pattern, 2: double Pattern */
  int vali;
  ...
  DBUG_ENTER ("nr_red_sscanf");
  START_MODUL("nr_red_sscanf");
