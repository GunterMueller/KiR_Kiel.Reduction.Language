...
/* original was rmstruct.c, difference is that here won't be any             */
...
extern nr_red_lcut();
extern nr_red_vcut();
extern nr_red_lselect();
extern nr_red_vselect();
extern nr_red_lreplace();
extern nr_red_vreplace();
extern nr_red_lrotate();
extern nr_red_vrotate();
extern nr_red_lunite();
extern nr_red_vunite();
...
/*****************************************************************************/
int nr_red_mcut(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_mcut");
  START_MODUL("nr_red_mcut");
...
/* changes for lred by RS in June 1993 */
  if ((T_POINTER(arg1) && T_POINTER(arg2) && T_POINTER(arg3)) ||
    ...
    if (rowcut > 0) {                                /* row - cutfirst      */
      nrows -= rowcut;
      DBUG_PRINT ("nr_red_mcut", ("nrows: %d", nrows));
    ...
    if (colcut > 0) {                                /* column - cutfirst   */
      ncols -= colcut;
       DBUG_PRINT ("nr_red_mcut", ("ncols: %d", ncols));
...
int nr_red_mselect(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_mselect");
  START_MODUL("nr_red_mselect");
...
int nr_red_mreplace(arg1,arg2,arg3,arg4)
STACKELEM arg1,arg2,arg3,arg4;
{
  ...
  DBUG_ENTER ("nr_red_mreplace");
  START_MODUL("nr_red_mreplace");
...
/* changes for lred by RS in June 1993 */
  ...
  if (T_INT(arg2))
   ...
   DBUG_PRINT ("nr_red_mreplace",("yo here am i !**************"));

  nrows = R_MVT(DESC(arg4),nrows,C_MATRIX);
  ncols = R_MVT(DESC(arg4),ncols,C_MATRIX);

  DBUG_PRINT ("nr_red_mreplace", ("col: %d, ncols: %d, row: %d, nrows: %d", col, ncols, row, nrows));
  ...
  DBUG_PRINT ("nr_red_mreplace", ("Is it a pointer: %d ???", T_POINTER(arg3)));
 ...
 DBUG_PRINT ("nr_red_mreplace",("still here ! **************"));
 ...
 /* changes for lred by RS in June 1993 */
  ...
  switch(type) {                             /* switch ueber eine Matrix     */
   ...
   /*~~~~~~~~~~~~~~~~*/
 /* changes for lred by RS in June 1993 */
         DBUG_PRINT ("nr_red_mreplace",("here am i !**************"));
    ...
    /* changes for lred by RS in June 1993 */
         if (T_INT(arg3) || (R_DESC(DESC(arg3),type) == TY_INTEGER)) {
           DBUG_PRINT ("nr_red_mreplace", ("Yoyo here am i ! *********"));
 ...
 DBUG_PRINT ("nr_red_mreplace",("here am i , that's not good !!**************"));

fail:
  END_MODUL("nr_red_mreplace");
  DBUG_RETURN(0);
success:
  /* changes for lred by RS in June 1993 */
success_3:
...
/* returns  :  stackelement  (pointer to result descriptor)                  */
/*****************************************************************************/
int nr_red_mre_c(arg1,arg2,arg3)
STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_mre_c");
  START_MODUL("nr_red_mre_c");
...
/* returns  :  stackelement  (pointer to result descriptor)                  */
/*****************************************************************************/
int nr_red_mre_r(arg1,arg2,arg3)
STACKELEM arg1,arg2,arg3;
{
  register int i,
               pos,                         /* position in dopevector        */
  ...
  DBUG_ENTER ("nr_red_mre_r");
  START_MODUL("nr_red_mre_r");
...
/* returns  :  stackelement  (pointer to result descriptor)                  */
/*****************************************************************************/
int nr_red_mrotate(arg1,arg2,arg3)
STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_mrotate");
  START_MODUL("nr_red_mrotate");
...
int nr_red_munite(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  ...
  DBUG_ENTER ("nr_red_munite");
  START_MODUL("nr_red_munite");
...
register STACKELEM arg1;
{
  ...
  DBUG_ENTER ("nr_red_transform");
  START_MODUL("nr_red_transform");
...
register STACKELEM arg1;
{
  ...
  DBUG_ENTER ("nr_red_transpose");
  START_MODUL("nr_red_transpose");
  ...
  if ((nrows == 1) || (ncols == 1)) {          /*----------------------------*/
    ...
    if (R_DESC(DESC(arg1),class) != C_MATRIX)  /*----------------------------*/
      post_mortem("nr_red_transpose: inconsistent descriptor class");
#endif
...
int nr_red_cut(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  int par1;                                 /* structuring parameter of arg1 */

  DBUG_ENTER ("nr_red_cut");
  START_MODUL("nr_red_cut");
  /* changes for lred by RS in June 1993 */
  ...
  switch(R_DESC(DESC(arg3),class)) {
     case C_LIST   : if (par1 != 0) goto fail;
                     if (nr_red_lcut(arg2,arg3) == 0)
                      goto fail;
                     goto decarg1;
     case C_VECTOR :
     case C_TVECTOR: if (par1 != 0) goto fail;
                     if (nr_red_vcut(arg2,arg3) == 0)
                       goto fail;
                     goto decarg1;
     case C_MATRIX : if (nr_red_mcut(arg1,arg2,arg3) == 0)
                       goto fail;
                     else
                       goto success;
     default       : goto fail;
...
int nr_red_select(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  int par1;                                /* structutring parameter of arg1 */

  DBUG_ENTER("nr_red_select");
  START_MODUL("nr_red_select");
  ...
  switch(R_DESC(DESC(arg3),class)) {
     case C_LIST   : if (par1 != 0) goto fail;
                     if (nr_red_lselect(arg2,arg3) == 0)
                       goto fail;
                     goto decarg1;
     case C_VECTOR :
     case C_TVECTOR: if (par1 != 0) goto fail;
                     if (nr_red_vselect(arg2,arg3) == 0)
                       goto fail;
                     goto decarg1;
     case C_MATRIX : if (nr_red_mselect(arg1,arg2,arg3) == 0)
                       goto fail;
                     else
                       goto success;
     default       : goto fail;
...
int nr_red_replace(arg1,arg2,arg3,arg4)
register STACKELEM arg1,arg2,arg3,arg4;
{
  int par1;                                /* structutring parameter of arg1 */

  DBUG_ENTER ("nr_red_replace");
  START_MODUL("nr_red_replace");
  ...
  switch(R_DESC(DESC(arg4),class)) {
     case C_LIST   : if (par1 != 0) goto fail;
                     if (nr_red_lreplace(arg2,arg3,arg4) == 0)
                       goto fail;
                     goto decarg1;
     case C_VECTOR :
     case C_TVECTOR: if (par1 != 0) goto fail;
                     if (nr_red_vreplace(arg2,arg3,arg4) == 0)
                       goto fail;
                     goto decarg1;
     case C_MATRIX : if (T_BOOLEAN(arg3)) {
                       if (nr_red_mreplace(arg1,arg2,arg3,arg4) == 0)
                         goto fail;
                       goto success;
                     }
                     else {
                       ...
                       switch(R_DESC(DESC(arg3),class)) {
                         case C_VECTOR : if (par1 != 0) goto fail;
                                         if (nr_red_mre_r(arg2,arg3,arg4) == 0)
                                           goto fail;
                                         goto decarg1;
                         case C_TVECTOR: if (par1 != 0) goto fail;
                                         if (nr_red_mre_c(arg2,arg3,arg4) == 0)
                                           goto fail;
                                         goto decarg1;
                         case C_LIST   :
                         case C_SCALAR :
                         case C_DIGIT  :
                         case C_MATRIX : if (nr_red_mreplace(arg1,arg2,arg3,arg4) == 0)
                                           goto fail;
                                         goto success;
                         default       : goto fail;
                       } /** end switch class arg3 **/
...
int nr_red_rotate(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  int par1;                                /* structutring parameter of arg1 */

  DBUG_ENTER ("nr_red_rotate");
  START_MODUL("nr_red_rotate");
  ...
  switch(R_DESC(DESC(arg3),class)) {
     case C_LIST   : if (par1 != 0) goto fail;
                     if (nr_red_lrotate(arg2,arg3) == 0)
                       goto fail;
                     goto decarg1;
     case C_VECTOR :
     case C_TVECTOR: if (par1 != 0) goto fail;
                     if (nr_red_vrotate(arg2,arg3) == 0)
                       goto fail;
                     goto decarg1;
     case C_MATRIX : if (nr_red_mrotate(arg1,arg2,arg3) == 0)
                       goto fail;
                     else
                       goto success;
     default       : goto fail;
...
int nr_red_unite(arg1,arg2,arg3)
register STACKELEM arg1,arg2,arg3;
{
  int par1;                                /* structutring parameter of arg1 */
  int class2, class3;                      /* class of arg2 and arg3         */

  DBUG_ENTER ("nr_red_unite");
  START_MODUL("nr_red_unite");
  ...
  if (T_POINTER(arg2) && T_POINTER(arg3)) {
    ...
    if (class2 == class3) {
      switch(class3) {
         case C_LIST   : if (par1 != 0) goto fail;
                         if (nr_red_lunite(arg2,arg3) == 0)
                           goto fail;
                         goto decarg1;
         case C_VECTOR :
         case C_TVECTOR: if (par1 == 0) {
                          if (nr_red_vunite(arg2,arg3) == 0)
                            goto fail;
                          goto decarg1;
                        }
         case C_MATRIX : if (nr_red_munite(arg1,arg2,arg3) == 0)
                           goto fail;
                         goto success;
         default       : goto fail;
      } /** end switch class3 **/
