...
/* 2. eine nichteindeutige Darstellung im Stack				  */
/* 3. eine Zeichenkette die die normale Syntax spezifiziert,              */
/* 4. eine Zeichenkette die die Paper-Syntax spezifiziert,                */
/* 5. die Mindestanzahl der Zeilen verringert um eins und                 */
/* 6. die Mindestanzahl der Spalten verringert um eins, die noetig sind   */
/*    um den Ausdruck extern darzustellen.                                */
/* 7. Infostelle fuer Version (?) und Unterscheidung verschiedener        */
/*    Ausgabearten (ASC oder pp, Vertikale Ausrichtung, ...)              */
/*                                                                        */
/* zu 1. siehe cetb.h                                                     */
/* zu 3. durch \33 wird die Codierung eines Unterausdrucks eingeleitet    */
/*  + 4. die drei Byte lang ist. Das erste Byte enthaelt eine Ausdruck-   */
...
E_EXPR,		AR0(AP),	"ap \33\0\0\0\nto [\3 \33\1\6\2 ]\3",
				"(\3 \33\0\0\0 \33\1\6\2 )\3",
							1,8,1
,E_EXPR,	AR0(SUB),	"sub [\3 \33\3\5\2 ]\3\nin \33\0\2\0",
				"LAMBDA \33\3\5\2 \nIN \33\0\2\0",
							1,9,1
#if ClausR
,E_EXPR,	AR0(SUB_CR),	"[.\3 \33\3\5\2 ].\3 \33\0\2\0",
				"",			0,8,1
#endif /* ClausR	*/
#ifdef AltV
...
,E_EXPR,	AR0(E_LET),	"let \33\63\105\0\nin \33\0\2\0",
				"",			 1,6,1
,E_LDEC,	AR0(LDEC),	"\33\64\0\4 =\3 \33\0\2\0",
				"",			0,4,2
...
,E_EXPR,	AR0(E_LETP),	"letp \33\66\105\0\nin \33\0\2\0",
				"",			 1,6,1
,E_PDEC,	AR0(PDEC),	"\33\42\0\4 =\3 \33\0\2\0",
				"",			0,4,1
/* alt:
,E_PDEC,	AR0(PDEC),	"\33\67\0\4 =\3 \33\0\2\0",
				"",			0,4,1
*/
#endif
...
,E_EXPR,	AR0(E_SEQ),	"seq \33\1\107\0\nin \33\0\2\0",
				"",			 1,6,1
,E_EXPR,	AR0(E_ASSIGN),	"set \33\74\0\1 =\3 \33\0\2\0",
				"",			 0,6,2
,E_VARSEL,	AR0(E_SEL),	"sel \33\64\0\1 \33\0\2\0",
				"",			0,4,2
/* Besma	*/


,E_EXPR,	AR0(ZF_UH),	"{.\3 \33\0\0\6 | \33\1\6\2 }\3",
				"",			0,10,0
,E_EXPR,	AR0(ZFIN_UH),	"<-\3 \33\2\0\2 \33\0\0\0",
				"",			0,9,0
...
,E_EXPR,	AR0(E_COMM),	"/*\3 \33\14\0\3 */\3\n\33\0\2\0",
				"",			1,6,0
,E_EXPR,	AR0(APAL),	"(\3 \33\0\2\6 \33\0\2\4 \33\0\2\2 )\3",
				"(\3 \33\0\2\4 \33\0\2\6 \33\0\2\2 )\3",
							0,8,0
,E_ATOM,	NIL,		"<>\3",		"",	0,1,0
,E_EXPR,	AR0(LIST),	"<\3 \33\1\6\2 >\3",
				"",			0,5,0
,E_ATOM,	NILARRAY,	"[]\3",		"",	0,1,0
,E_EXPR,	AR0(E_ARRAY),	"[\3 \33\1\6\2 ]\3",
				"",			0,5,0
#if N_STR
,E_STRVAL,	NILSTR,		"'`\3",		"",	0,1,0
,E_STRPATT,	NILSTR,		"'`\3",		"",	0,1,0
,E_STRPATT,	AR0(KQUOTE),	"'\3\33\51\46\1`\3",
				"",			0,3,0
,E_STRVAL,	AR0(KQUOTE),	"'\3\33\53\46\1`\3",
				"",			0,3,0
/*-dg 12.07.90 korrektur */
,E_STRPATT,	AR0(EPM_SAS),	"\"as \33\50\2\3 \"\33\2\2\1\"\3",
				"",			0,7,0 
,E_STRPATT,	AR0(EPM_IN),	"\"in \33\60\2\3 \33\14\2\1\"\3",
				"",			0,7,0 
...
,E_STRPATT,	AR0(EPM_VAR),	"\"\3\33\2\2\1\"\3",
				"",			0,3,0

/*
,E_EXPR,	AR0(E_DISON),	"dis$on\3[ \33\0\0\6, \33\0\0\4, \33\0\0\0 ]\3",
				"",			0,14,0
*/
,E_EXPR,	AR0(E_DISON),	"dis$on\3[ \33\0\0\10, \33\0\0\6, \33\0\0\4, \33\0\0\0 ]\3",
				"",			0,16,0

,E_EXPR,	AR0(E_MAP_),	"map$_\3[ \33\0\0\4, \33\0\0\0 ]\3",
				"",			0,10,0
,E_EXPR,	AR0(E_MAP),	"map$\3[ \33\0\0\4, \33\0\0\0 ]\3",
				"",			0,9,0
,E_EXPR,	AR0(E_ONEOF),	"one$of\3[ \33\0\0\0 ]\3",
				"",			0,7,0
,E_EXPR,	AR0(E_SUCCESS),	"success$\3[ \33\0\0\0 ]\3",
				"",			0,9,0

,E_LIST,	NIL,		"<>\3",		"",	0,1,0
,E_LIST,	AR0(LIST),	"<\3 \33\1\6\2 >\3",
				"",			0,5,0
#endif
...
,E_WHEN,	AR0(EPM_MATCH),"match \33\42\2\6 \33\0\2\4 \33\0\2\2 \33\0\2\0",
				"",			0,12,0
#if N_STR
,E_N_PATT,	AR0(NPATT),	"(\3 \33\43\6\2 )\3",
				"",			0,5,0
,E_PATT1,	AR0(PM_VARC),	"^\3\33\2\2\0",
				"",			0,2,0
/*-dg 12.07.90 3 Zeilen korrektur */
,E_PATT1,	AR0(EPM_AS),	"as \33\57\2\2 \33\2\2\0",
				"",			0,5,0
,E_PATT1,	AR0(EPM_LIST),	"<(\3\33\2\2\3)\3 \33\57\2\0",
				"",			0,5,0
,E_PATT1,	AR0(EPM_LIST),	"list \33\2\2\2 \33\57\2\0",
				"",			0,7,0
,E_PATT1,	AR0(LIST),	"<\3 \33\43\6\2 >\3",
				"",			0,5,0
,E_PATT1,	AR0(EPM_NOT),	"not \33\43\2\0",
				"",			0,5,0
...
#else
/*-dg 12.07.90 3 Zeilen korrektur */
,E_PATTERN,	AR0(EPM_AS),	"as \33\57\2\2 \33\2\2\0",
				"",			0,5,0
,E_PATTERN,	AR0(EPM_LIST),	"<(\3\33\2\2\3)\3 \33\57\2\0",
				"",			0,5,0
,E_PATTERN,	AR0(EPM_LIST),	"list \33\2\2\2 \33\57\2\0",
				"",			0,7,0
,E_PATTERN,	AR0(LIST),	"<\3 \33\43\6\2 >\3",
				"",			0,5,0
,E_PATTERN,	AR0(EPM_NOT),	"not \33\43\2\0",
				"",			0,5,0
,E_WH_PA,	PM_FAIL,	"fail",		"",	0,3,0
,E_WH_PA,	PM_SUCC,	"ok  ",		"",	0,3,0
...
#endif
/*
,E_WHEN,	AR0(EPM_WHEN),	"when \33\57\2\2 \33\44\12\0",
				"",			0,7,0
,E_GUARD,	AR0(EPM_GUARD),	"guard \33\0\2\2 \33\45\12\0",
				"",			0,8,0
,E_DO,		AR0(EPM_DO),	"do \33\0\2\0",
				"",			0,4,0
*/
...
,E_WHEN_CR,	AR0(WHEN_CR),	"when \33\42\2\0\n do \33\0\2\0",
				"",			1,7,0
,E_EXPR,	NILSTRUCT,	"nilstruct", "", 0,8,0       /* cr 11.12.95 */
...
,E_EXPR,	AR0(E_ERROR),	"error\3: \33\0\0\0",
				"",			0,7,0
,E_EXPR,	AR0(E_STOP),	"stop\3: \33\1\6\0",
				"",			0,7,0
/* achtung hier: PREDEF gesetzt wg. encsearch ? */
,E_LBAR,	AR0(PROTECT),	"\\\3\33\5\2\0",
				"",			0,1,0 | PREDEF

,E_EXPR,	AR0(FILNAM),	"$\3\33\2\2\0",
				"",			0,1,0
,E_EXPR,	AR0(FILRED),	"^\3\33\2\2\0",
				"",			0,1,0
,E_EXPR,	AR0(FILPRE),	"!\3\33\2\2\0",
				"",			0,1,0
#ifdef UnBenutzt
,E_SCAL,	AR0(DECSCAL),	"dec \33\10\2\0",
				"",			0,4,0
,E_EXPR,	AR0(F),		"rat [\3 \33\10\2\6 | \33\10\2\2 ]\3",
				"",			0,12,0

,E_SET,		AR0(SET),	"set \n\33\16\12\0",
				"SET \n\33\16\12\0",	1,3,0
,E_SETOBJ,	AR0(LIST),	"<\3 \33\7\6\2 >\3",
				"",			0,5,0
#endif
...
,E_MAT,		AR0(FIELDFIELD),"mmat \n\33\26\116\1.\3",
				"",			1,6,0
,E_FMATRL,	AR0(LIST),	"<\3 \33\25\6\2 >\3",
				"",			0,5,0
,E_MAT,		AR0(NUMBFIELD),	"mat \n\33\17\116\0.\3",
				"",			1,4,0
,E_NMATRL,	AR0(LIST),	"<\3 \33\22\6\2 >\3",
				"",			0,5,0
,E_MAT,		AR0(BOOLFIELD),	"bmat \n\33\20\116\0.\3",
				"",			1,4,0
,E_BMATRL,	AR0(LIST),	"<\3 \33\23\6\2 >\3",
				"",			0,5,0
,E_MAT,		AR0(STRFIELD),	"smat \n\33\21\116\0.\3",
				"",			1,4,0
,E_SMATRL,	AR0(LIST),	"<\3 \33\24\6\2 >\3",
				"",			0,5,0
,E_FMATEL,	NILFIELD,	"nilmat",
				"",			0,5,0

,E_NVECOBJ,	AR0(NVECT),	"vect\3< \33\11\6\2 >\3",
				"",			0,9,0
,E_BVECOBJ,	AR0(BVECT),	"bvect\3< \33\13\6\2 >\3",
				"",			0,10,0
,E_SVECOBJ,	AR0(SVECT),	"svect\3< \33\15\6\2 >\3",
				"",			0,10,0
,E_ATOM,	NILVECT,	"nilvect",
				"",			0,6,0

,E_NVECOBJ,	AR0(NTVECT),	"tvect\3< \33\11\106\2 >\3",
				"",			0,10,0
,E_BVECOBJ,	AR0(BTVECT),	"btvect\3< \33\13\106\2 >\3",
				"",			0,11,0
,E_SVECOBJ,	AR0(STVECT),	"stvect\3< \33\15\106\2 >\3",
				"",			0,11,0
,E_ATOM,	NILTVECT,	"niltvect",
				"",			0,7,0
#else
...
,E_FUNC,	D_QUOT,		"quot",	"",	0,3,0 | PREDEF | PRIM_FKT
...
/* stt 7.09.95: Interaktionen fuer KiR-I/O */
,E_FUNC,        IA_FOPEN,       "fopen",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_FCLOSE,      "fclose",       "",     0,5,0 | PREDEF
,E_FUNC,        IA_FGETC,       "fgetc",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_FPUTC,       "fputc",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_UNGETC,      "ungetc",       "",     0,5,0 | PREDEF
,E_FUNC,        IA_FGETS,       "fgets",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_FPUTS,       "fputs",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_READ,        "read",         "",     0,3,0 | PREDEF
,E_FUNC,        IA_FREDIRECT,   "fredirect",    "",     0,8,0 | PREDEF
,E_FUNC,        IA_FSEEK,       "fseek",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_FTELL,       "ftell",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_EOF,         "eof",          "",     0,2,0 | PREDEF
,E_FUNC,        IA_EXIT,        "exit",         "",     0,3,0 | PREDEF
,E_FUNC,        IA_BIND,        "bind",         "",     0,3,0 | PREDEF
,E_FUNC,        IA_UNIT,        "unit",         "",     0,3,0 | PREDEF
,E_FUNC,        IA_FINFO,       "finfo",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_STATUS,      "status",       "",     0,5,0 | PREDEF
,E_FUNC,        IA_REMOVE,      "remove",       "",     0,5,0 | PREDEF
,E_FUNC,        IA_RENAME,      "rename",       "",     0,5,0 | PREDEF
,E_FUNC,        IA_COPY,        "copy",         "",     0,3,0 | PREDEF
,E_FUNC,        IA_MKDIR,       "mkdir",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_RMDIR,       "rmdir",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_CHDIR,       "chdir",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_GETWD,       "getwd",        "",     0,4,0 | PREDEF
,E_FUNC,        IA_DIR,         "dir",          "",     0,2,0 | PREDEF
,E_FUNC,        IA_GET,         "get",          "",     0,2,0 | PREDEF
,E_FUNC,        IA_PUT,         "put",          "",     0,2,0 | PREDEF

,E_FUNC,  IA_SET_SPEED,   "set_speed",          "",     0,8,0 | PREDEF
,E_FUNC,  IA_GET_SPEED,   "get_speed",          "",     0,8,0 | PREDEF
,E_FUNC,IA_SET_DIRECTION,"set_direction",          "",     0,12,0 | PREDEF
,E_FUNC,IA_GET_DIRECTION,"get_direction",          "",     0,12,0 | PREDEF
,E_FUNC,  IA_SET_POINT,   "set_point",          "",     0,8,0 | PREDEF
,E_FUNC,  IA_GET_POINT,   "get_point",          "",     0,8,0 | PREDEF
,E_FUNC,  IA_SET_RELAY,   "set_relay",          "",     0,8,0 | PREDEF
,E_FUNC,  IA_GET_RELAY,   "get_relay",          "",     0,8,0 | PREDEF
,E_FUNC, IA_SET_SIGNAL,  "set_signal",          "",     0,9,0 | PREDEF
,E_FUNC, IA_GET_SIGNAL,  "get_signal",          "",     0,9,0 | PREDEF
,E_FUNC,    IA_READ_M1,     "read_M1",          "",     0,6,0 | PREDEF
,E_FUNC,    IA_READ_M2,     "read_M2",          "",     0,6,0 | PREDEF

#if ClausR
,E_FUNC,	AND_CR,		"AND",		"",	0,2,0 | PREDEF
,E_FUNC,	OR_CR,		"OR",		"",	0,1,0 | PREDEF
,E_FUNC,	FILTER_CR,"filter",	"",	0,5,0 | PREDEF
,E_FUNC,	FR_TEST,	"ftest",	"",	0,4,0 | PREDEF
,E_FUNC,	FR_SELECT,"fselect",	"",	0,6,0 | PREDEF
,E_FUNC,	FR_UPDATE,"fupdate",	"",	0,6,0 | PREDEF
,E_FUNC,	FR_SLOTS, "fslots",	"",	0,5,0 | PREDEF
,E_FUNC,	FR_DELETE,"fdelete",	"",	0,6,0 | PREDEF
...
/* stt 28.02.96: Zahl-String-Wandlung */
,E_FUNC,        TO_CHAR,        "char",         "",     0,3,0 | PREDEF
,E_FUNC,        TO_ORD,         "ord",          "",     0,2,0 | PREDEF
,E_FUNC,        SPRINTF,        "sprintf",      "",     0,6,0 | PREDEF
,E_FUNC,        SSCANF,         "sscanf",       "",     0,5,0 | PREDEF

,E_FUNC,        SPECMAP,        "specmap",      "",     0,6,0 | PREDEF | PRIM_FKT
...
,E_FDEC,	AR0(DECL_CR),"&\3from \33\0\0\0 \n import \5[\3 \33\3\204\6 ]\3",
				"&\3from \33\0\0\0 \n import \5[\3 \33\3\204\6 ]\3",								1,12,2 | VERTIKAL
,E_FDEC,	AR0(FDEC),"\33\32\2\13 \5[\3 \33\3\205\6 ]\3 \5=\3 \33\36\2\0",
				"\33\32\2\13 \33\3\205\6 \5=\3 \33\36\2\0",								0,12,2 | VERTIKAL
,E_FDEC,	AR0(FDEC),"\33\32\2\11 \5[\3 \33\3\205\4 ]\3 \5=\3\n \33\36\2\0",
				"\33\32\2\11 \33\3\205\6 \5=\3 \33\36\2\0",
							1,10,2
/*
,E_FDEC,	AR0(FDEC),	"_func_ \33\32\2\13 \5[\3 \33\3\205\6 ]\3 \5=\3 \33\36\2\0",
				"",			0,19,2
*/
,E_DECL,	AR0(DECL),	"def \n  \33\30\105\0\nin \33\0\2\0",
				"LETREC \n  \33\30\105\0\nIN \33\0\2\0",
...
,E_CALL,	AR0(CALL),	"\33\35\2\7 \5[\3 \33\1\206\2 ]\3",
				"(\3 \33\35\2\7 \33\1\206\2 )\3",
							0,7,0 | PRINT
,E_CALL,	AR0(CALL),	"_call_ \33\35\2\7 \5[\3 \33\1\206\2 ]\3",
				"(\3 \33\35\2\7 \33\1\206\2 )\3",
							0,14,0
,E_CALL,	AR0(CALL1),	"\33\35\2\6\5(\3 \33\0\2\2 )\3",
				"(\3 \33\35\2\6 \33\0\2\2 )\3",
							0,7,0
,E_CALL,	AR0(CALL2),	"\33\35\2\12\5(\3 \33\0\2\6 , \33\0\2\2 )\3",
				"(\3 \33\35\2\12 \33\0\2\6 \33\0\2\2 )\3",
							0,11,0
,E_CALL,	AR0(CALL3),	"\33\35\2\16\5(\3 \33\0\2\12 , \33\0\2\6 , \33\0\2\2 )\3",
				"(\3 \33\35\2\16 \33\0\2\12 \33\0\2\6 \33\0\2\2 )\3",
							0,15,0
,E_CALL,	AR0(CALL4),	"\33\35\2\20\5(\3 \33\0\2\16 , \33\0\2\12 , \33\0\2\6 , \33\0\2\2 )\3",
  				"(\3 \33\35\2\20 \33\0\2\16 \33\0\2\12 \33\0\2\6 \33\0\2\2 )\3",
							0,19,0
/* benutzer-definierte konstruktoren !      */
,E_USKON,	AR0(US_KON),	"\33\35\2\4\4{\3\33\1\206\1}\3",
				"",			0,5,0 | PRINT
,E_USKON,	AR0(US_KON),	"_kon_ \33\35\2\4\4{\3\33\1\206\1}\3",
				"\33\35\2\4\4{\3\33\1\206\1}\3",
							0,11,0
,E_USKONP,	AR0(US_KON),	"\33\35\2\4\4{\3\33\43\206\1}\3",
				"",			0,5,0 | PRINT
,E_USKONP,	AR0(US_KON),	"_konp_ \33\35\2\4\4{\3\33\43\206\1}\3",
				"\33\35\2\4\4{\3\33\43\206\1}\3",
							0,12,0
...
*/
	...
	,"ceil"		,M_CEIL		,func_arity(M_CEIL)
        ,"char"         ,TO_CHAR        ,func_arity(TO_CHAR)
...
#if	ClausR
	,"fdelete"	,FR_DELETE	,func_arity(FR_DELETE) /* cr 04.12.95 */
...
#if	ClausR
	,"fselect"	,FR_SELECT ,func_arity(FR_SELECT)
	,"fslots"	,FR_SLOTS ,func_arity(FR_SLOTS) /* cr 04.12.95 */
	,"ftest"	  ,FR_TEST	 ,func_arity(FR_TEST)
	,"fupdate"	,FR_UPDATE ,func_arity(FR_UPDATE)
#endif	/*	ClausR	*/
...
/*	,"lubnorm"	,LUB_NORM	,func_arity(LUB_NORM)	*/
	...
	,"or"		,D_OR		,func_arity(D_OR)
        ,"ord"          ,TO_ORD         ,func_arity(TO_ORD)
        ,"specmap"      ,SPECMAP        ,func_arity(SPECMAP)
	,"plus"		,D_PLUS		,func_arity(D_PLUS)
	,"quot"		,D_QUOT		,func_arity(D_QUOT)
...
/*	,"solve"	,SOLVE		,func_arity(SOLVE)	*/
        ,"sprintf"      ,SPRINTF        ,func_arity(SPRINTF)
        ,"sscanf"       ,SSCANF         ,func_arity(SSCANF)
#if	N_MAT
...
/* hier alle predefined interactions auffuehren (s.o.)     */
predefined interactions[] = {
     "bind"     ,IA_BIND    ,func_arity(IA_BIND)
    ,"chdir"    ,IA_CHDIR   ,func_arity(IA_CHDIR)
    ,"copy"     ,IA_COPY    ,func_arity(IA_COPY)
    ,"dir"      ,IA_DIR     ,func_arity(IA_DIR)
    ,"eof"      ,IA_EOF     ,func_arity(IA_EOF)
    ,"exit"     ,IA_EXIT    ,func_arity(IA_EXIT)
    ,"fclose"   ,IA_FCLOSE  ,func_arity(IA_FCLOSE)
    ,"fgetc"    ,IA_FGETC   ,func_arity(IA_FGETC)
    ,"fgets"    ,IA_FGETS   ,func_arity(IA_FGETS)
    ,"finfo"    ,IA_FINFO   ,func_arity(IA_FINFO)
    ,"fopen"    ,IA_FOPEN   ,func_arity(IA_FOPEN)
    ,"fputc"    ,IA_FPUTC   ,func_arity(IA_FPUTC)
    ,"fputs"    ,IA_FPUTS   ,func_arity(IA_FPUTS)
    ,"fredirect",IA_FREDIRECT,func_arity(IA_FREDIRECT)
    ,"fseek"    ,IA_FSEEK   ,func_arity(IA_FSEEK)
    ,"ftell"    ,IA_FTELL   ,func_arity(IA_FTELL)
    ,"get"      ,IA_GET     ,func_arity(IA_GET)
    ,"getwd"    ,IA_GETWD   ,func_arity(IA_GETWD)
    ,"mkdir"    ,IA_MKDIR   ,func_arity(IA_MKDIR)
    ,"put"      ,IA_PUT     ,func_arity(IA_PUT)
    ,"read"     ,IA_READ    ,func_arity(IA_READ)
    ,"remove"   ,IA_REMOVE  ,func_arity(IA_REMOVE)
    ,"rename"   ,IA_RENAME  ,func_arity(IA_RENAME)
    ,"rmdir"    ,IA_RMDIR   ,func_arity(IA_RMDIR)
    ,"status"   ,IA_STATUS  ,func_arity(IA_STATUS)
    ,"ungetc"   ,IA_UNGETC  ,func_arity(IA_UNGETC)
    ,"unit"     ,IA_UNIT    ,func_arity(IA_UNIT)
    ,"set_speed",IA_SET_SPEED,func_arity(IA_SET_SPEED)
    ,"get_speed",IA_GET_SPEED,func_arity(IA_GET_SPEED)
    ,"set_direction",IA_SET_DIRECTION,func_arity(IA_SET_DIRECTION)
    ,"get_direction",IA_GET_DIRECTION,func_arity(IA_GET_DIRECTION)
    ,"set_point",IA_SET_POINT,func_arity(IA_SET_POINT)
    ,"get_point",IA_GET_POINT,func_arity(IA_GET_POINT)
    ,"set_relay",IA_SET_RELAY,func_arity(IA_SET_RELAY)
    ,"get_relay",IA_GET_RELAY,func_arity(IA_GET_RELAY)
    ,"set_signal",IA_SET_SIGNAL,func_arity(IA_SET_SIGNAL)
    ,"get_signal",IA_GET_SIGNAL,func_arity(IA_GET_SIGNAL)
    ,"read_M1",IA_READ_M1,func_arity(IA_READ_M1)
    ,"read_M2",IA_READ_M2,func_arity(IA_READ_M2)
};
...
#define NINTACT (sizeof(interactions)/sizeof(interactions[0]))
