/*
 * $Log: rinter.h,v $
 * Revision 1.25  2001/07/02 14:53:33  base
 * compiler warnings eliminated
 *
 * Revision 1.24  1998/02/18 13:34:36  rs
 * modifications for speculative evaluations regarding
 * meaning preserving transformations
 *
 * Revision 1.23  1997/04/14  09:52:06  rs
...
extern int post_mortem();      /* RS 02/11/92 */ 
...
/* Befehle fuer spekulative Auswertung */

#define I_SPECDIST 107
#define I_SPECWIN  108
#define I_SPECEND  109
#define I_SPECWAIT 110
#define I_MKNCASE 111
#define I_SPECGUARD 112
#define I_SPECINIT 113
...
/* Verteilungs- und Messkram RS ab 1.1.1993 */
  ...
  ,{I_SPECDIST  ,"SPECDIST"  ,4 ,NUM_PAR}   /* speculative DIST */
  ,{I_SPECWIN   ,"SPECWIN"   ,0 ,ZERO_PAR}  /* speculative RTF-like inside PM */
  ,{I_SPECEND   ,"SPECEND"   ,0 ,ZERO_PAR}  /* transmits the result back */
  ,{I_SPECWAIT  ,"SPECWAIT"  ,0 ,ZERO_PAR}  /* speculative WAIT inside PM */
  ,{I_MKNCASE   ,"MKNCASE"   ,1 ,DESC_PAR}  /* for post-processing */
  ,{I_SPECGUARD  ,"SPECGUARD"  ,0 ,ZERO_PAR}  /* signals failure inside PM */
  ,{I_SPECINIT  ,"SPECINIT"  ,0 ,ZERO_PAR}  /* initialize speculative process */
