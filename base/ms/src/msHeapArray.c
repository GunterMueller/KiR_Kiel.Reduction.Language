...
extern void msDisplayPanelSetCaching();
extern void msDisplayPanelSetStacking();
extern void msDisplayPanelSetFragmentation();
extern void msDisplayPanelSetSeparation();
...
/* actions */
extern void msHeapArrayMousePosition();
extern void msHeapArrayClickLeft();
extern void msHeapArrayClickMiddle();
extern void msHeapArrayClickRight();
...
char *argv[];
{
	...
	WcRegisterCallback(app, "msDisplayPanelSetCaching",
			   msDisplayPanelSetCaching, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetStacking",
			   msDisplayPanelSetStacking, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetFragmentation",
			   msDisplayPanelSetFragmentation, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetSeparation",
			   msDisplayPanelSetSeparation, NULL);
	...
	WcRegisterAction(app, "msHeapArrayMousePosition",
                         msHeapArrayMousePosition, NULL);
	WcRegisterAction(app, "msHeapArrayClickLeft",
                         msHeapArrayClickLeft, NULL);
	WcRegisterAction(app, "msHeapArrayClickMiddle",
                         msHeapArrayClickMiddle, NULL);
	WcRegisterAction(app, "msHeapArrayClickRight",
                         msHeapArrayClickRight, NULL);
