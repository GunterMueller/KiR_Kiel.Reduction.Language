...
extern void msHistoryPanelEnterLevel();
extern void msHistoryPanelIncreaseLevel();
extern void msHistoryPanelDecreaseLevel();
extern void msHistoryPanelSetLevel();
extern void msFuturePanelEnterLevel();
extern void msFuturePanelIncreaseLevel();
extern void msFuturePanelDecreaseLevel();
extern void msFuturePanelSetLevel();
extern void msDisplayPanelSetTitle();
extern void msDisplayPanelSetStyleNone();
extern void msDisplayPanelSetStyleText();
extern void msDisplayPanelSetStyleColor();
extern void msDisplayPanelSetMeter();
extern void msDisplayPanelClear();
extern void msDisplayPanelRedraw();
...
/* actions */
extern void msProcArrayMousePosition();
extern void msProcArrayClickLeft();
extern void msProcArrayClickMiddle();
extern void msProcArrayClickRight();
...
char *argv[];
{
	...
	WcRegisterCallback(app, "msHistoryPanelEnterLevel",
			   msHistoryPanelEnterLevel, NULL);
	WcRegisterCallback(app, "msHistoryPanelIncreaseLevel",
			   msHistoryPanelIncreaseLevel, NULL);
	WcRegisterCallback(app, "msHistoryPanelDecreaseLevel",
			   msHistoryPanelDecreaseLevel, NULL);
	WcRegisterCallback(app, "msHistoryPanelSetLevel",
			   msHistoryPanelSetLevel, NULL);
	WcRegisterCallback(app, "msFuturePanelEnterLevel",
			   msFuturePanelEnterLevel, NULL);
	WcRegisterCallback(app, "msFuturePanelIncreaseLevel",
			   msFuturePanelIncreaseLevel, NULL);
	WcRegisterCallback(app, "msFuturePanelDecreaseLevel",
			   msFuturePanelDecreaseLevel, NULL);
	WcRegisterCallback(app, "msFuturePanelSetLevel",
			   msFuturePanelSetLevel, NULL);

	WcRegisterCallback(app, "msDisplayPanelSetTitle",
			   msDisplayPanelSetTitle, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetStyleNone",
			   msDisplayPanelSetStyleNone, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetStyleText",
			   msDisplayPanelSetStyleText, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetStyleColor",
			   msDisplayPanelSetStyleColor, NULL);
	WcRegisterCallback(app, "msDisplayPanelSetMeter",
			   msDisplayPanelSetMeter, NULL);
	WcRegisterCallback(app, "msDisplayPanelClear",
			   msDisplayPanelClear, NULL);
	WcRegisterCallback(app, "msDisplayPanelRedraw",
			   msDisplayPanelRedraw, NULL);
	...
	WcRegisterAction(app, "msProcArrayMousePosition",
                         msProcArrayMousePosition, NULL);
	WcRegisterAction(app, "msProcArrayClickLeft",
                         msProcArrayClickLeft, NULL);
	WcRegisterAction(app, "msProcArrayClickMiddle",
                         msProcArrayClickMiddle, NULL);
	WcRegisterAction(app, "msProcArrayClickRight",
                         msProcArrayClickRight, NULL);
