...
the window you want to work with on a workstation.}\index{up key}\index{down key}\index{left key}\index{right key}. If you just
...
The expression returned after the first step 
