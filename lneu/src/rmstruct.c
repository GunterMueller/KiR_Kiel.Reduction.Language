...
/* special functions :                                                       */
/* -------------------                                                       */
/*    special Functions which changing the structure of  matrices or         */
/*    vectors   or   transposed vectors                                      */
/*                                                                           */
/*    MATRIX functions:                                                      */
/*                -- external:  red_mcut,    red_mreplace,   red_mre_c,      */
/*                              red_mre_r ,  red_mselect,    red_mrotate,    */
/*                              red_munite                                   */
/*                                                                           */
/*    MATRIX and VECTOR / TVECTOR  function:                                 */
/*                -- external:  red_transform, red_transpose                 */
/*                                                                           */
/* universal functions :                                                     */
/* ---------------------                                                     */
/*    universal Functions which changing the structure of  matrices or       */
/*    vectors   or   transposed vectors  or lists  or strings                */
/*                                                                           */
/*                -- external:  red_cut,        red_select,     red_replace, */
/*                              red_rotate      red_unite                    */
/*                                                                           */
/* called by : rear.c and the universal functions                            */
/*****************************************************************************/
...
/*                       external functions                                  */
/*---------------------------------------------------------------------------*/
extern int red_lcut();              /*  rlstruct.c  */
extern int red_vcut();              /*  rvstruct.c  */
extern int red_lreplace();          /*  rlstruct.c  */
extern int red_vreplace();          /*  rvstruct.c  */
extern int red_lrotate();           /*  rlstruct.c  */
extern int red_vrotate();           /*  rvstruct.c  */
extern int red_lselect();           /*  rlstruct.c  */
extern int red_vselect();           /*  rvstruct.c  */
extern int red_lunite();            /*  rlstruct.c  */
extern int red_vunite();            /*  rvstruct.c  */
...
register STACKELEM arg1,arg2,arg3;
{
  ...
  int pos;                         /* die Position des ersten Elementes der  */
                                   ...
                                   /* muss.                                  */
  int jump;                        /* die Zahl der Elemente die bei einem    */
...
STACKELEM arg1,arg2,arg3,arg4;
{
  ...
  switch(type) {                             /* switch ueber eine Matrix     */
   ...
   /*~~~~~~~~~~~~~~~~*/
         ...
         if (R_DESC(DESC(arg3),type) == TY_INTEGER) {
