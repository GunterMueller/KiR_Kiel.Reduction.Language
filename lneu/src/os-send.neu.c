...

{
  ...
  {
    DBUG_PRINT( "ERRS", ("ERROR : can't allocate list-descriptor !") );
...

{
  ...
  {
    DBUG_PRINT( "ERRS", ("ERROR : no space in heap for the data !") );
    post_mortem_intern();
  }
...

{
  ...
  {
    DBUG_PRINT( "ERRS", ("ERROR : no space in heap for the list !") );
    post_mortem_intern();
  }
...

{
  ...
  {
    DBUG_PRINT( "ERRS", ("ERROR : no space in heap for the heap-elements !") );
    post_mortem_intern();
  }
  (* elem)[0] = laenge;
...

{
  ...
  {
    DBUG_PRINT( "ERRS", ("ERROR : no space in heap for the code-vector !") );
    post_mortem_intern();
  }
...

{
  ...
  else
  {
    ...
    {
      DBUG_PRINT( "ERRS", ("ERROR : can't allocate descriptors anymore !") );
      post_mortem_intern();
    }
